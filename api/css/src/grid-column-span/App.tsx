  ...
  return (
    <>
      ...
      <view className="container">
        <text className="item" style={{ backgroundColor: "rgb(255,53,26)", gridColumnSpan: "1" }}>ONE</text>
      ...
      <view className="container">
        <text className="item" style={{ backgroundColor: "rgb(255,53,26)", gridColumnSpan: "2" }}>ONE</text>
        <text className="item">TWO</text>
        <text className="item">THREE</text>
      </view>
      ...
      <view className="container">
        <text className="item" style={{ backgroundColor: "rgb(255,53,26)", gridColumnSpan: "3" }}>ONE</text>
        <text className="item">TWO</text>
        <text className="item">THREE</text>
      </view>
    </>
