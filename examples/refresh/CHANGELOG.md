...
- 1699fbd: Remove the local `intrinsic-element.d.ts` declaration. `<refresh>` and `<refresh-header>` are now provided by `@lynx-js/types@3.8.0`.
- a07db67: Remove `@ts-expect-error` comment.
